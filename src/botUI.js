...
function BotUi({ topicData }) {
  ...
  return (
    <div>
      <form
        className="fixed pt-0 bottom-6 right-16 inline-flex items-center justify-center "
        onSubmit={(e) => {
          e.preventDefault();
          sendToAI();
        }}
      ...
      <div
        ...
        ref={messageEl}
        className="fixed bottom-[calc(4rem+1.5rem)] right-0 mr-0 bg-white p-6 rounded-lg border border-[#e5e7eb] w-[440px] h-[634px]"
      >
