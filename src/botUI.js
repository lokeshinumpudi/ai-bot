...
function BotUi({ topicData }) {
  ...
  return (
    <div>
      <div className="fixed pt-0 mt-8 bottom-6 w-full inline-flex items-center justify-center ">
        <form
          className=""
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <div className="flex flex-wrap ">
            <textarea
              className="flex h-28 w-full rounded-md border border-[#e5e7eb] px-3 py-2 text-sm placeholder-[#6b7280] focus:outline-none focus:ring-2 focus:ring-[#9ca3af] disabled:cursor-not-allowed disabled:opacity-50 text-[#030712] focus-visible:ring-offset-2"
            ...
            />
            <button
              className="inline-flex w-full  items-center justify-center rounded-md text-sm font-medium text-[#f9fafb] disabled:pointer-events-none disabled:opacity-50 bg-black hover:bg-[#111827E6] h-10 px-4 py-2"
              onClick={sendToAI}
            >
              Send
            </button>
